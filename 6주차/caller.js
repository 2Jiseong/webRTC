...
var btn_change = document.querySelector('#change');
var input_nickname = document.querySelector('#input_nickname');
var output_nickname = document.querySelector('#output_nickname');
